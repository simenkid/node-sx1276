...
REG.LORA = {
    ...
    Reserved32: { address: 0x32 },
    InvertIQ: {
        address: 0x33,
        fields: {
            reserved: { shift: 7, bitwide: 1 },
            invertIQ: { shift: 6, bitwide: 1 },
            rx: { shift: 2, bitwide: 1 },       // invert LoRa I & Q signal, UNDOCUMENTED
            txOff:  { shift: 0, bitwide: 1 }    // invert LoRa I & Q signals, UNDOCUMENTED

        }
    },
    Reserved34: { address: 0x34 },
    Reserved35: { address: 0x35 },
    Reserved36: { address: 0x36 },
    DetectionThreshold: { address: 0x37 },
    Reserved38: { address: 0x38 },
    SyncWord: { address: 0x39 },
    Reserved3a: { address: 0x3a },
    InvertIQ2: { address: 0x3b },   // undocumented register
    Reserved3c: { address: 0x3c },
    Reserved3d: { address: 0x3d },
    Reserved3e: { address: 0x3e },
    Reserved3f: { address: 0x3f },
    Reserved44: { address: 0x44 },
    Reserved5d: { address: 0x5d },
};
...
REG.parseRegVal = function (regHdl, value) {
    ...
    if (!regDef)
        throw new Error('Invalid regHdl: ' + regHdl);
...
REG.rebuildRegVal = function (regHdl, currentVal, data) {
    var regDef = REG.def(regHdl),
        fields,
        byteVal = 0x00;
    ...
    if (!_.isObject(data))
        throw new Error('data should be a number or an object');
