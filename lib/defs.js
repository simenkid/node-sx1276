...
var REG_FSK = {
    // 0x32 ~ 0x3f
    PaylaodLength: { adress: 0x32 },
    NodeAdrs: { adress: 0x33 },
    BroadcastAdrs: { adress: 0x34 },
    FifoThresh: {
        adress: 0x35,
        fields: {
    ...
    Timer1Coef: { adress: 0x39 },
    Timer2Coef: { adress: 0x3a },
    ImageCal: {
        adress: 0x3b,
        fields: {
...
var REG_LORA = {
    ...
    // 0x34 ~ 0x36 - reserved
    DetectionThreshould: { adress: 0x37 },
    // 0x38 - reserved
    SyncWord: { adress: 0x39 },
    // 0x3a ~ 0x3f - reserved
    // 0x44 - unused
    // 0x5d - unused
};
...
var REG_FSK = {
    ...
    PreambleMsb: { adress: 0x25 },
    PreambleLsb: { adress: 0x26 },
    SyncConfig: {
        adress: 0x27,
        fields: {
    ...
    SyncValue1: { adress: 0x28 },
    SyncValue2: { adress: 0x29 },
    SyncValue3: { adress: 0x2a },
    SyncValue4: { adress: 0x2b },
    SyncValue5: { adress: 0x2c },
    SyncValue6: { adress: 0x2d },
    SyncValue7: { adress: 0x2e },
    SyncValue8: { adress: 0x2f },
    PacketConfig1: {
        adress: 0x30,
        fields: {
...
var REG_LORA = {
    ...
    MaxPayloadLength: { adress: 0x23 }
    HopPeriod: { adress: 0x24 }
    FifoRxByteAddr: { adress: 0x25 }
    ModemConfig3: {
        adress: 0x26,
        fields: {
            unused:                 { shift: 4, bitwide: 4 },
    ...
    FeiMid: { adress: 0x29 }
    FeiLsb: { adress: 0x2a }
    Reserved2b: { adress: 0x2b } 
    RssiWideband: { adress: 0x2c }
    Reserved2d: { adress: 0x2d } 
    Reserved2e: { adress: 0x2e } 
    Reserved2f: { adress: 0x2f }
    Reserved30: { adress: 0x30 }
    DetectOptimize: {
        adress: 0x31,
        fields: {
