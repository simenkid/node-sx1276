...
// OK
Sx1276.prototype.write = function (regHdl, valObj, callback) {
    var self = this;

    this.readReg(regHdl).then(function (val) {
        var rebuiltVal = REG.rebuildRegVal(regHdl, val, valObj);
...
Sx1276.prototype.writeReg = function (regHdl, val, callback) {
    ...
    outPkt[0] = REG.addrToWrite(regHdl);
...
// OK
Sx1276.prototype.useChannel = function (freq, callback) {
    var self = this,
...
//-- how to fallback
Sx1276.prototype.useModem = function (modemType, callback) {
    var self = this,
